...
El código anterior representa lo que un desarrollador escribiría para describir el componente. A continuación se muestran las transformaciones que el Optimizer de Qwik aplica al código para que se le pueda aplicar lazy load.
