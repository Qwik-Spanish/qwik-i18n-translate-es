...
Qwik aprovecha [Vite](https://vitejs.dev/) para brindar una experiencia de desarrollo rápida. Vite es una herramienta de construcción que sirve tu código a través de módulos nativos de ES durante el desarrollo.
...
```js
/**
 * La entry strategy de Qwik que se utilizará en la build de producción.
