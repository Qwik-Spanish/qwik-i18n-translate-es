...
1. El navegador descarga el HTML y ejecuta el script Qwikloader en línea. El Qwikloader, entonces, configura oyentes globales para todos los eventos del navegador.
...
2. **El código del listene**: Qwik necesita saber qué código debe ejecutarse si se activa el evento.
