...
Un concepto clave de las aplicaciones Qwik es que son resumibles desde un estado renderizado en el servidor. La mejor manera de explicar la resumibilidad es entender cómo funcionan las aplicaciones actuales de replay (hidratación) de frameworks.
...
La resumibilidad se trata de pausar la ejecución en el servidor y reanudarla en el cliente sin tener que reproducir y descargar toda la lógica de la aplicación.
